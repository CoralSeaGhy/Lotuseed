...
@implementation LSDHistoryReplyCell
...
- (void)initSubViews {
    ...
    _icon = [[UIImageView alloc] initWithFrame:CGRectMake(KScreenWid - 65, 30, 60, 60)];
    _icon.contentMode = UIViewContentModeScaleToFill;
    _icon.image = [UIImage imageNamed:@"ser"];
    [self.contentView addSubview:_icon];
    
    _img = [[UIImageView alloc] initWithFrame:CGRectMake(KScreenWid - 150, 30, 60, 60)];
    ...
    //    _bgView.backgroundColor = [UIColor colorWithRed:216 / 255.0 green:244 / 255.0 blue:253 / 255.0 alpha:1.0];
    _bgView.layer.cornerRadius = 5;
    _bgView.clipsToBounds = YES;
    _bgView.image = [UIImage imageNamed:@"reply"];
...
- (void)setFeedBackVO:(LSDFeedBackVO *)feedBackVO
{
    ...
    if (feedBackVO.fileName && feedBackVO.fileName.length != 0) {
        ...
        _contentLbl.frame = CGRectMake(5, 30, KScreenWid - 160, 20);
        _bgView.frame = CGRectMake(5, 25, KScreenWid - 75, 70);
        ...
        _contentLbl.frame = CGRectMake( 5, 30, KScreenWid - 90, 60);
        _bgView.frame = CGRectMake(5, 25, KScreenWid - 75, 70);
    }
